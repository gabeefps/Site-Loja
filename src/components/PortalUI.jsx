export function PageHeader({ eyebrow, title, description, action }) {
  return <div className="portal-head"><div><small>{eyebrow}</small><h1 className="display">{title}</h1><p>{description}</p></div>{action && <button className="portal-action">＋ {action}</button>}</div>;
}
